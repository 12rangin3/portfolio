      ...
      <Container>
        <Row className="align-items-center">
          <Col md={6} className="hero-left">
            ...
            <h1 className="hero-name fade-up delay-2">Swagat Kumar</h1>
            ...
            <p className="hero-desc fade-up delay-4">
              Building bridges between Front-End and Back-End, turning ideas
              into real-world web solutions. Focused on writing clean code,
              designing intuitive interfaces, and integrating powerful back-end
              systems to create complete web applications.
            </p>
            ...
            <div className="hero-buttons fade-up delay-5">
              ...
              <Button className="btn-outline-glow" href="#contact">
                Let's Connect
              </Button>
            </div>
          </Col>
          ...
          <Col
            md={6}
            className="d-flex justify-content-center fade-zoom delay-3"
          >
